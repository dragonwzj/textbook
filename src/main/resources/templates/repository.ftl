...
<div class="container-fluid">
    <div class="row" style="margin-top: 15px">
        <h2 class="col-6">仓库列表</h2>
        <div class="col-6">
            <a href="/repository_add" class="btn btn-primary float-right">建立新仓库</a>
        </div>
            ...
            <table class="table table-hover table-sm">
                ...
                <#list repositories as repository>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary btn-sm" href="/repository_store_order?repositoryCode=${repository.repositoryCode!}">查看出入库记录</a>
                        </td>
                    </tr>
                </#list>
                </tbody>
