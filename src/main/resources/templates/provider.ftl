...
<div class="container-fluid">
    <div class="row" style="margin-top: 15px">
        <h2 class="col-6">供应商列表</h2>
        <div class="col-6">
            <a href="/provider_add" class="btn btn-primary float-right">录入新供应商信息</a>
        </div>
        <div class="table-responsive">
            <table class="table table-hover table-sm">
                ...
                <#list providers as provider>
                    <tr>
                        <td>${provider_index+1}</td>
                        <td>${provider.providerCode!}</td>
                        <td>${provider.providerName!}</td>
                        <td>${provider.tel!}</td>
                        <td>
                            <a class="btn btn-success btn-sm" href="/buy?providerCode=${provider.providerCode!}">购买</a>
                            <a class="btn btn-primary btn-sm" href="/buy_order?providerCode=${provider.providerCode!}">查看购书记录</a>
                        </td>
                    </tr>
                </#list>
                </tbody>
